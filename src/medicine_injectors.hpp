...
class InjectorPromedol : InjectorBase
{
    ...
    hiddenSelectionsTextures[] = { "BreakPoint\BPSyberiaScripts\data\medical\injector_blue_co.paa" };
...
class InjectorZivirol : InjectorBase
{
    ...
    hiddenSelections[] = {"zbytek"};
    hiddenSelectionsTextures[] = { "BreakPoint\BPSyberiaScripts\data\medical\injector_red_co.paa" };
    ITEM_DAMAGE_SYSTEM(100, "DZ\gear\medical\data\Morphine.rvmat", "DZ\gear\medical\data\Morphine_damage.rvmat", "DZ\gear\medical\data\Morphine_destruct.rvmat");
    INJECTOR_ANIM_EVENTS;
};
...
class InjectorTopoizomeraza : InjectorBase
{
    ...
    medRemoveSepsis=1;
    hiddenSelections[] = {"zbytek"};
    hiddenSelectionsTextures[] = { "BreakPoint\BPSyberiaScripts\data\medical\injector_green_co.paa" };
    ITEM_DAMAGE_SYSTEM(100, "DZ\gear\medical\data\Morphine.rvmat", "DZ\gear\medical\data\Morphine_damage.rvmat", "DZ\gear\medical\data\Morphine_destruct.rvmat");
    INJECTOR_ANIM_EVENTS;
};
...
class InjectorRadioprotector : InjectorBase
{
    ...
    hiddenSelections[] = {"zbytek"};
    hiddenSelectionsTextures[] = { "BreakPoint\BPSyberiaScripts\data\medical\injector_yellow_co.paa" };
    ITEM_DAMAGE_SYSTEM(100, "DZ\gear\medical\data\Morphine.rvmat", "DZ\gear\medical\data\Morphine_damage.rvmat", "DZ\gear\medical\data\Morphine_destruct.rvmat");
    INJECTOR_ANIM_EVENTS;
};