class SybTraderMenu extends UIScriptedMenu
{
	...
	{		
		ref Widget itemSell = GetGame().GetWorkspace().CreateWidgets( "BreakPoint/BPSyberiaScripts/layout/TraderMenuItemSell.layout" );		
	...
	{
		ref Widget itemBuy = GetGame().GetWorkspace().CreateWidgets( "BreakPoint/BPSyberiaScripts/layout/TraderMenuItemBuy.layout" );		
    ...
    {
		layoutRoot = GetGame().GetWorkspace().CreateWidgets( "BreakPoint/BPSyberiaScripts/layout/TraderMenu.layout" );
