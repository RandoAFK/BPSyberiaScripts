class GearPDAMenu extends UIScriptedMenu
{
    ...
    {
		layoutRoot = GetGame().GetWorkspace().CreateWidgets( "BreakPoint/BPSyberiaScripts/layout/GearPDAMenu.layout" );
	...
	void UpdateMap()
	{
		...
		m_map.AddUserMark(pos, "", ARGBF(1, 0.690, 0.152, 0.188), "BreakPoint\\BPSyberiaScripts\\data\\pda\\marker.paa");
		m_map.SetScale(0.05);
