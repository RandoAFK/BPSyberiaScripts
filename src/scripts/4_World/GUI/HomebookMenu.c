class HomebookMenu extends UIScriptedMenu
{
    ...
    {
		layoutRoot = GetGame().GetWorkspace().CreateWidgets( "BreakPoint/BPSyberiaScripts/layout/HomebookMenu.layout" );
	...
	{		
		ref Widget itemWidget = GetGame().GetWorkspace().CreateWidgets( "BreakPoint/BPSyberiaScripts/layout/HomebookMenuItemDoor.layout" );		
		...
		if (m_livespace.IsDoorOpen(doorData.m_selfDoorId)) {
			widgetIcon.LoadImageFile(0, "BreakPoint/BPSyberiaScripts/data/gui/Homebook/icon_unlocked.paa");
			doorState = "State: Opened";		
		}
		else {
			widgetIcon.LoadImageFile(0, "BreakPoint/BPSyberiaScripts/data/gui/Homebook/icon_locked.paa");
	...
	{
		ref Widget itemWidget = GetGame().GetWorkspace().CreateWidgets( "BreakPoint/BPSyberiaScripts/layout/HomebookMenuConsumable.layout" );		
